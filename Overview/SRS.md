...
El sistema consiste en un dron ensamblado mediante un kit comercial y un control remoto personalizado. El sistema permitirá la transmisión de comandos de control utilizando comunicación inalámbrica LoRa.
...
4. Verificación y Validación *(No requerido)*  
5. Matriz de Trazabilidad *(No requerido)*
...
El sistema deberá procesar y transmitir comandos en tiempo cercano a real para garantizar un control adecuado del dron.
...
### 4.1 Arquitectura del Dron

*(Definir posteriormente en documento de arquitectura)*

---

### 4.2 Arquitectura del Control Remoto
...
- **Ensamblaje del dron:** Salvador, Daniel  
- **Electrónica:** Jair, Salvador  
  - Responsable de módulos LoRa, conexiones y energía.

- **Diseño PCB:** Jair, Daniel  
  - Responsable del diseño y validación de la placa.

- **Programación / Comunicación:** Salvador, Rafael  
  - Responsable de transmisión y recepción de datos.

- **Documentación:** Rafael, Daniel  
